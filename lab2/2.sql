...
(1, 1, 1, 200, '2024-10-01'), 
(2, 2, 2, 50, '2024-10-08'),
(3, 3, 3, 60, '2024-10-15'),
(4, 1, 2, 80, '2024-10-20'),
(5, 2, 1, 120, '2024-10-05'),  
(6, 3, 3, 100, '2024-11-10');  
--проекты у которых превышен бюджет
SELECT 
    p.project_id,
    p.department_id,
...
--сотрудники которые переработали
